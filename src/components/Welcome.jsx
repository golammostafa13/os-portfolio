...
const Welcome = () => {
    ...
    useGSAP(() => {
        const titleSetup = setupTextHover(titleRef.current, "title");
        const subtitleSetup = setupTextHover(subtitleRef.current, "subtitle");
    ...
    return (
        <section id="welcome">
            <p ref={subtitleRef}>{renderText("Salam, I'm Golam Mostafa! Welcome to my", "text-3xl font-georama", 100)}</p>
